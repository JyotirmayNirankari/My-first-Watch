...
function draw(){
    ...
    noStroke();
    fill("Yellow");
    text("By Jyotirmay Nirankari",615,240);

    textSize(25);
    noStroke();
    fill(0,0,255);
    text("BLUE stands for HOUR HAND", 620,290);

    textSize(25);
    noStroke();
    fill(255,0,0);
    text("RED stands for SECONDS HAND", 620,370);

    textSize(25);
    noStroke();
    fill(0,255,0);
    text("GREEN stands for MINUTES HAND", 620,330);
